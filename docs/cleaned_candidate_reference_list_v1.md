# TRUST-Swarm Cleaned Candidate Reference List v1

This file removes obvious duplicate references and adds Information Fusion candidate references.

This is still a candidate list, not the final journal bibliography. DOI, venue, author order, and peer-reviewed status still need audit.
...
## Candidate Information Fusion References
...
- Information Fusion references: 15
- Total candidate references: 68


## Next Audit Step

The next step is to verify DOI, venue, peer-reviewed status, and relevance for the highest-priority references before inserting them into the final manuscript.