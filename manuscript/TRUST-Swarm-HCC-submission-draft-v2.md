...
TRUST-Swarm includes a PPO-based recovery-reasoning scaffold to connect mission-state prediction, confidence, entropy, and mission-risk indicators to possible recovery actions. The recovery layer is not claimed as a operationally deployable UAV controller. Instead, it demonstrates how high-confidence prediction outputs can support active-defense-style mission reasoning.
...
The purpose of this evaluation is not to claim complete OOD reliability. Instead, it identifies mission-risk conditions where model performance degrades or confidence becomes unreliable.
...
This module is included to demonstrate how prediction, confidence, entropy, and mission-risk indicators can support mission-response reasoning. It is not claimed as a operationally deployable UAV controller.
