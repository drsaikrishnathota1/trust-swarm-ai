...
related_path = Path("docs/hcc_related_work_v2.md")
builder_path = Path("scripts/build_hcc_manuscript_v1.py")

related_text = """# High-Confidence Computing Related Work v2
...
related_path.write_text(related_text)

if builder_path.exists():
    b = builder_path.read_text()
    b = b.replace('ROOT / "docs" / "hcc_related_work_v1.md"', 'ROOT / "docs" / "hcc_related_work_v2.md"')
    b = b.replace('text = text.replace("# High-Confidence Computing Related Work v1", "")',
...
print("Updated manuscript builder to use Related Work v2.")
