...
bar_svg(OUT / "figure_v5_model_f1_comparison.svg", "RA-MARS v5 Model Macro-F1 Comparison", labels, values, "Macro-F1 (%)")
...
bar_svg(OUT / "figure_v5_mission_success_by_scenario.svg", "RA-MARS v5 Mission Success by Scenario", labels, values, "Mission Success (%)")
...
bar_svg(OUT / "figure_v5_ablation_mission_success.svg", "RA-MARS v5 Ablation Study", labels, values, "Mission Success (%)")
...
bar_svg(OUT / "figure_v5_rf_sinr_validation.svg", "RA-MARS v5 RF/SINR Validation", labels, values, "Mean SINR (dB)")
...
bar_svg(OUT / "figure_v5_detection_delay.svg", "RA-MARS v5 Detection Delay", labels, values, "Delay")
...
if adv_path.exists():
    ...
    bar_svg(OUT / "figure_v5_adversarial_training_robustness.svg", "RA-MARS v5 Adversarial Training Robustness", labels, values, "Adversarial Macro-F1 (%)")
else:
    print("Skipped adversarial figure: missing simulations/results/adversarial_training_results_v4.csv")

print("All available v5 SVG figures generated.")
