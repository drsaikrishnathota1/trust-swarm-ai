# TRUST-Swarm Information Fusion Manuscript v3

**Working title:** TRUST-Swarm: Trustworthy Graph-Temporal Multi-Source Information Fusion for High-Confidence UAV Swarm Mission Assurance Under Cyber-Physical Attacks
...
## A. UAV / UAS Security, Swarms, and Cyber-Physical Attacks
...
## B. Graph Neural Networks and Graph-Temporal Learning
...
## C. Temporal Baselines and Deep Learning Foundations
...
## D. Uncertainty Calibration and High-Confidence AI
...
## E. OOD Detection and Distribution Shift
...
## F. Explainable AI and Feature Importance
...
## G. Reinforcement Learning and Recovery Reasoning
...
* References [1]–[7] support UAV security, UAS risk, UAV swarm spoofing, multi-robot cooperation, and graph-based multi-agent coordination.
* References [8]–[13] support graph neural networks, graph attention, transformers, temporal modeling, and time-series anomaly detection.
* References [14]–[17] support LSTM, GRU, optimizer, and training foundations used for baselines.
* References [18]–[24] support calibration, uncertainty estimation, MC dropout, ensembles, and uncertainty under dataset shift.
* References [25]–[28] support OOD detection and distribution-shift evaluation.
* References [29]–[32] support explainability and feature-importance analysis.
* Reference [33] supports PPO-based mission-recovery reasoning.

## Next Reference Work

Batch 2 should add more UAV-specific and cyber-physical security references, especially:

1. UAV jamming detection
2. anti-jamming UAV communication
3. GNSS spoofing detection
4. telemetry tampering
5. intrusion detection for UAV networks
6. resilient UAV swarm control
7. high-confidence computing and AI assurance
...
## H. UAV Security, Privacy, and Cyber-Physical Mission Risk
...
## I. UAV Jamming and Anti-Jamming Communication
...
## J. GPS / GNSS Spoofing and Navigation Integrity
...
[46] Mykytyn, P., Brzozowski, M., Dyka, Z., & Langendoerfer, P. (2023). GPS-Spoofing Attack Detection Mechanism for UAV Swarms. arXiv:2301.12766.

[47] Bi, S., Li, K., Hu, S., Ni, W., Wang, C., & Wang, X. (2023). Detection and Mitigation of Position Spoofing Attacks on Cooperative UAV Swarm Formations. arXiv:2312.03787.

---

## K. Reinforcement Learning for UAV Mission Planning and Recovery
...
## L. AI Safety, Adversarial Robustness, and Trustworthy Autonomy
...
## How Batch 2 Supports TRUST-Swarm

* References [34]–[37] strengthen the UAV security and cyber-physical risk background.
* References [38]–[42] support jamming, anti-jamming communication, and adversarial UAV communication environments.
* References [43]–[47] support GPS/GNSS spoofing, navigation integrity, and UAV swarm spoofing detection.
* References [48]–[53] support reinforcement-learning-based UAV planning and recovery reasoning.
* References [54]–[55] support adversarial robustness and trustworthy AI positioning.

## Updated Reference Count

Batch 1: 33 references
Batch 2: 22 references
